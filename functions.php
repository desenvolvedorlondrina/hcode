 ...
 * @param string $separator Separador de milhar
 *
 * @return string
 */
function formatPrice(?float $number, string $separator = "."): string
{
    return number_format((float) $number, 2, ",", $separator);
}
...
{
    if ($html === strip_tags((string) $html)) {
        return nl2br($html);
    }
