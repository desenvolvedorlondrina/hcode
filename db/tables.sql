...
CREATE TABLE tb_products_categories (
    ...
    dt_category_added_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data de vínculo do produto com a categoria',
...
CREATE TABLE tb_carts (
    ...
    is_own_delivery TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'É entrega própria?',
