...
putenv("PHP_ROOT_DIR=" . __DIR__ . DIRECTORY_SEPARATOR); // Caminho até a raiz do projeto
...
putenv("SECRET_IV=PlataformaUdemy"); // Contra chave para criptografia
date_default_timezone_set("America/Sao_Paulo"); // Localização para ajustar o horário


// Banco de dados
putenv("MYSQL_HOSTNAME=url"); // Servidor SQL
putenv("MYSQL_DRIVER=mysql"); // Driver SQL
putenv("MYSQL_SCHEMA=database"); // Nome do banco de dados
putenv("MYSQL_USERNAME=user"); // Nome do usuário
putenv("MYSQL_PASSWORD=pass"); // Senha de acesso
...
putenv("COURIER_DEFAULT_SHIPPING_PRICE=35.00"); // Preço de envio padrão
putenv("COURIER_MAXIMUM_DELIVERY_TIME=15"); // Prazo máximo de entrega
