...
class Page
{
     ...
     * Propriedade
     *
     * @var bool Retorna o HTML ou imprime?
     */
     ...
     * Propriedade
     *
     * @var array<string> Vetor de templates HTML
     */
     ...
     * Propriedade
     *
     * @var array<string,mixed> Opções de template
     */
     ...
     * @return void
     */
    public function __construct(array $options = [], string $directory = DIRECTORY_SEPARATOR . "views" . DIRECTORY_SEPARATOR, bool $returnHTML = true)
    {
        ...
        $configurations = [
            ...
            "cache_dir" => $root . DIRECTORY_SEPARATOR . "views-cache" . DIRECTORY_SEPARATOR,
