...
class SQL extends \PDO
{
     ...
     * Propriedade
     *
     * @var int Identificadores das conexões abertas
     */
    private int $_id;
     ...
     * Propriedade
     *
     * @var array<self> Vetor estáticos das conexões abertas
     */
    ...
    public function __construct(
        ...
        try {
            ...
            throw new HttpException("Falha ao conectar-se na base de dados" . ($this->_debug ? (" (" . $e->getMessage() . ")") : "") . ".", 500);
        }
    }
     ...
     *
     * @param array<mixed> $configurations Vetor com as configurações
     *
     * @static
     *
     * @return self
    ...
    public function send(string $query, array $parameters = [], bool $param = false): \PDOStatement
    {
        ...
        try {
            ...
            throw new HttpException("Falha ao realizar a consulta na base de dados ({$e->getMessage()}).", 500);
        }
