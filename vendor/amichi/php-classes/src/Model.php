...
abstract class Model
{
     ...
     * Propriedade
     *
     * @var array<string,mixed> Valores auxiliares
     */
     ...
     * Propriedade
     *
     * @var array<string,array<int,self>> Valores em cache para evitar consultas repetidas ao banco
     */
    ...
    public function __get(string $name): mixed
    {
        ...
        throw new HttpException("Atributo \"$name\" não existe.", 500);
    }
    ...
    public function __call(string $name, array $arguments): mixed
    {
        ...
        return match ($method) {
            ...
            "get", "is" => $this->values[$field] ?? throw new HttpException("Argumento \"$field\" não existe no uso da função \"$name(" . implode(", ", $arguments) . ")\".", 500),
            default => throw new HttpException("Função \"$name(" . implode(", ", $arguments) . ")\" não existe.", 500)
        };
    }
