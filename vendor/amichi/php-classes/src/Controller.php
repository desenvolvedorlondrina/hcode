...
abstract class Controller
{
    ...
    public static function int(mixed &$value, bool $required = false, string $name = ""): int
    {
        ...
        throw new HttpException("É necessário informar um número inteiro no parâmetro " . ($name ? "\"$name\"" : "requerido") . ".", 400);
    }
    ...
    public static function float(mixed &$value, bool $required = false, string $name = ""): float
    {
        ...
        throw new HttpException("É necessário informar um ponto flutuante no parâmetro " . ($name ? "\"$name\"" : "requerido") . ".", 400);
    }
    ...
    public static function bool(mixed &$value, bool $required = false, string $name = ""): bool
    {
        ...
        throw new HttpException("É necessário informar um valor booleano no parâmetro " . ($name ? "\"$name\"" : "requerido") . ".", 400);
    }
    ...
    public static function string(mixed &$value, bool $required = false, string $name = ""): string
    {
        ...
        throw new HttpException("É necessário informar um texto no parâmetro " . ($name ? "\"$name\"" : "requerido") . ".", 400);
    }
    ...
    public static function array(mixed &$value, bool $required = false, string $name = ""): array
    {
        ...
        throw new HttpException("É necessário informar um vetor no parâmetro " . ($name ? "\"$name\"" : "requerido") . ".", 400);
    }
}
