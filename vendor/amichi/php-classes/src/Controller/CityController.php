...
class CityController extends Controller
{
    ...
    public static function post(Request $request, Response $response, array $args): Response
    {
        ...
        if ($errors) {
            ...
            throw new HttpException("Não foi possível cadastrar a cidade. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function put(Request $request, Response $response, array $args): Response
    {
        ...
        if (!City::loadFromId($id)) {
            throw new HttpException("Não foi possível alterar a cidade $id, pois, é inexistente.", 400);
        }
        ...
        if ($errors) {
            $message = count($errors) === 1 ? "O seguinte erro foi encontrado" : "Os seguintes erros foram encontrados";
            throw new HttpException("Não foi possível alterar a cidade $id. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$city) {
            throw new HttpException("Não foi possível remover a cidade $id, pois, é inexistente.", 400);
        }
        ...
        if (!empty($addresses)) {
            ...
            throw new HttpException("Não foi possível remover a cidade $id, pois, está vinculada $message " . implode(", ", $addressesIds) . ".", 400);
        }
