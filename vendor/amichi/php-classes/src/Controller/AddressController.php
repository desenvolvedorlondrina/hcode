...
class AddressController extends Controller
{
    ...
    public static function post(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$sessionUser->isAdmin) {
            if (Address::loadFromPersonId($sessionUser->idPerson)) {
                throw new HttpException("Não foi possível cadastrar o endereço, pois, você já possui um endereço cadastrado.", 400);
            }
        ...
        if ($errors) {
            ...
            throw new HttpException("Não foi possível cadastrar o endereço. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function put(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$addressDB) {
            throw new HttpException("Não foi possível alterar o endereço $id, pois, é inexistente.", 400);
        }
        ...
        if ($sessionUser->idPerson !== $address->idPerson && !$sessionUser->isAdmin) {
            throw new HttpException("Não foi possível alterar o endereço $id, pois, você não possui permissão.", 400);
        }
        ...
        if ($errors) {
            $message = count($errors) === 1 ? "O seguinte erro foi encontrado" : "Os seguintes erros foram encontrados";
            throw new HttpException("Não foi possível alterar o endereço $id. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$address) {
            throw new HttpException("Não foi possível remover o endereço $id, pois, é inexistente.", 400);
        }
        ...
        if ($orders) {
            ...
            throw new HttpException("Não foi possível remover o endereço $id, pois, está vinculado $message " . implode(", ", $ordersIds) . ".", 400);
        }
