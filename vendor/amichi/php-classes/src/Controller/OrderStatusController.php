...
class OrderStatusController extends Controller
{
    ...
    public static function post(Request $request, Response $response, array $args): Response
    {
        ...
        if ($errors) {
            ...
            throw new HttpException("Não foi possível cadastrar o status de pedido. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function put(Request $request, Response $response, array $args): Response
    {
        ...
        if (!OrderStatus::loadFromId($id)) {
            throw new HttpException("Não foi possível alterar o status de pedido $id, pois, é inexistente.", 400);
        }
        ...
        if ($errors) {
            $message = count($errors) === 1 ? "O seguinte erro foi encontrado" : "Os seguintes erros foram encontrados";
            throw new HttpException("Não foi possível alterar o status de pedido $id. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$orderStatus) {
            throw new HttpException("Não foi possível remover o status de pedido $id, pois, é inexistente.", 400);
        }
        ...
        if ($orders) {
            ...
            throw new HttpException("Não foi possível remover o status de pedido $id, pois, está vinculado $message " . implode(", ", $ordersIds) . ".", 400);
        }
