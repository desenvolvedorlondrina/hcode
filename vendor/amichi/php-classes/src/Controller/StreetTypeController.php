...
class StreetTypeController extends Controller
{
    ...
    public static function post(Request $request, Response $response, array $args): Response
    {
        ...
        if ($errors) {
            ...
            throw new HttpException("Não foi possível cadastrar o tipo de logradouro. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function put(Request $request, Response $response, array $args): Response
    {
        ...
        if (!StreetType::loadFromId($id)) {
            throw new HttpException("Não foi possível alterar o tipo de logradouro $id, pois, é inexistente.", 400);
        }
        ...
        if ($errors) {
            $message = count($errors) === 1 ? "O seguinte erro foi encontrado" : "Os seguintes erros foram encontrados";
            throw new HttpException("Não foi possível alterar o tipo de logradouro $id. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$streetType) {
            throw new HttpException("Não foi possível remover o tipo de logradouro $id, pois, é inexistente.", 400);
        }
        ...
        if (!empty($addresses)) {
            ...
            throw new HttpException("Não foi possível remover o tipo de logradouro $id, pois, está vinculado $message " . implode(", ", $addressesIds) . ".", 400);
        }
