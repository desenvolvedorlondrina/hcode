...
class MailController extends Controller
{
    ...
    public static function post(Request $request, Response $response, array $args): Response
    {
        ...
        if ($errors) {
            ...
            throw new HttpException("Não foi possível enviar o e-mail. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function put(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$mail) {
            throw new HttpException("Não foi possível alterar o e-mail $id, pois, é inexistente.", 400);
        }

        if ($mail->isSent) {
            throw new HttpException("Não foi possível reenviar o e-mail $id, pois, já foi enviado.", 400);
        }
        ...
        if ($errors) {
            $message = count($errors) === 1 ? "O seguinte erro foi encontrado" : "Os seguintes erros foram encontrados";
            throw new HttpException("Não foi possível alterar o e-mail $id. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$mail) {
            throw new HttpException("Não foi possível remover o e-mail $id, pois, é inexistente.", 400);
        }
