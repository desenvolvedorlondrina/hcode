...
class TopicController extends Controller
{
    ...
    public static function post(Request $request, Response $response, array $args): Response
    {
        ...
        if ($errors) {
            ...
            throw new HttpException("Não foi possível cadastrar o tópico. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function put(Request $request, Response $response, array $args): Response
    {
        ...
        if (!Topic::loadFromId($id)) {
            throw new HttpException("Não foi possível alterar o tópico $id, pois, é inexistente.", 400);
        }
        ...
        if ($errors) {
            $message = count($errors) === 1 ? "O seguinte erro foi encontrado" : "Os seguintes erros foram encontrados";
            throw new HttpException("Não foi possível alterar o tópico $id. $message: " . implode(", ", $errors) . ".", 400);
        }
    ...
    public static function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$topic) {
            throw new HttpException("Não foi possível remover o tópico $id, pois, é inexistente.", 400);
        }
